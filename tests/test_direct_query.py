...
params_d = ['253802']
params_cricsheet = ['253802', "ICC Men's T20 World Cup, 2024"]
...
query = """
    WITH combined_deliveries AS (
        ...
        WHERE d.batsman_id = %s AND c.class_name IN ('T20', 'Twenty20', 'IPL', 'Women T20', 'Women''s T20', 'Other T20', 'T20I', 'Youth T20I', 'ICCT') AND c.event_id IN (SELECT el.event_id FROM cricket.event_leagues el JOIN cricket.leagues l ON el.league_id = l.id WHERE l.name = 'ICC Men''s T20 World Cup, 2024')
        ...
        WHERE d.batsman_id = %s AND m.format IN ('T20', 'Twenty20', 'IT20') AND 
            m.match_date IN (
