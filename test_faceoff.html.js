            ...
            async function fetchFaceoffFilters(sourceId = null) {
                ...
                const currentPitchLine = plnSelect ? plnSelect.value || 'All' : 'All';
            ...
            if(document.getElementById('filterFormat')) document.getElementById('filterFormat').addEventListener('change', () => fetchFaceoffFilters('filterFormat'));
            if(document.getElementById('filterLeague')) document.getElementById('filterLeague').addEventListener('change', () => fetchFaceoffFilters('filterLeague'));
            if(document.getElementById('filterVenue')) document.getElementById('filterVenue').addEventListener('change', () => fetchFaceoffFilters('filterVenue'));
            if(document.getElementById('filterYear')) document.getElementById('filterYear').addEventListener('change', () => fetchFaceoffFilters('filterYear'));
            if(document.getElementById('filterPhase')) document.getElementById('filterPhase').addEventListener('change', () => fetchFaceoffFilters('filterPhase'));
            if(document.getElementById('filterInnings')) document.getElementById('filterInnings').addEventListener('change', () => fetchFaceoffFilters('filterInnings'));
            if(document.getElementById('filterResult')) document.getElementById('filterResult').addEventListener('change', () => fetchFaceoffFilters('filterResult'));
            if(document.getElementById('filterRecent')) document.getElementById('filterRecent').addEventListener('change', () => fetchFaceoffFilters('filterRecent'));
            if(document.getElementById('filterWicketType')) document.getElementById('filterWicketType').addEventListener('change', () => fetchFaceoffFilters('filterWicketType'));
            if(document.getElementById('filterPitchLength')) document.getElementById('filterPitchLength').addEventListener('change', () => fetchFaceoffFilters('filterPitchLength'));
            if(document.getElementById('filterPitchLine')) document.getElementById('filterPitchLine').addEventListener('change', () => fetchFaceoffFilters('filterPitchLine'));
            if(document.getElementById('filterShotType')) document.getElementById('filterShotType').addEventListener('change', () => fetchFaceoffFilters('filterShotType'));
            ...
            function initWagonChart(data) {
                ...
                if (scatterData.length === 0) {
                    ...
                    let drawnSpokes = [];
                    const batOriginY = centerY + 25; // Bottom popping crease
            ...
            async function fetchStats() {
                if (!currentBatterId || !currentBowlerId) {
                    alert("Please select both a Batter and a Bowler before comparing.");
                    return;
                }
                ...
                const baseParams = new URLSearchParams({
                    batter_id: currentBatterId, bowler_id: currentBowlerId,
